    ...
    <div className="group relative aspect-square border border-[#003322] hover:border-[#00ff88] transition-all duration-300 bg-black/40 overflow-hidden">
      ...
      {photo.title && isLoaded && (
        <div className="absolute bottom-0 left-0 right-0 p-2 sm:p-3 bg-black/80 border-t border-[#003322] transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
          <span className="text-[#00ff88] text-[8px] sm:text-[10px] tracking-widest uppercase truncate block">
            {photo.title}
          </span>
        </div>
      )}
    ...
    <div className="absolute inset-0 z-40 flex flex-col font-mono animate-in fade-in zoom-in-95 duration-500 bg-black/95">
      ...
      <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-[#00ff88] flex-shrink-0 bg-black/40 backdrop-blur-sm">
        ...
        <div className="flex items-center gap-4 sm:gap-6">
          ...
          <button
            onClick={onClose}
            className="text-[#00ff88] border border-[#00ff88] px-2 sm:px-3 py-1 text-xs sm:text-sm tracking-widest hover:bg-[#00ff88] hover:text-black transition-all duration-200 whitespace-nowrap"
          >
            [X] CLOSE
          </button>
        </div>
      ...
      <div className="mt-auto border-t border-[#003322] bg-black/80 p-4 sm:p-6 flex flex-col items-center gap-3 sm:gap-4 backdrop-blur-md">
        <div className="text-[#006633] text-[8px] sm:text-[10px] tracking-[0.4em] uppercase text-center">
        ...
        <a
          ...
          className="w-full sm:w-auto text-center text-[#00ff88] border border-[#00ff88] px-4 sm:px-8 py-2.5 sm:py-3 text-[10px] sm:text-xs tracking-[0.3em] font-bold hover:bg-[#00ff88] hover:text-black transition-all duration-300 shadow-[0_0_15px_rgba(0,255,136,0.1)] hover:shadow-[0_0_20px_rgba(0,255,136,0.3)]"
        >
